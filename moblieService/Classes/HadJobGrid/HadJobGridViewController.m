...
#import "HadJobGridViewController.h"
#import "ScreenViewController.h"

@interface HadJobGridViewController ()

@end

@implementation HadJobGridViewController
{
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    if (!self.showback)
    {
        ...
        UIButton *leftBtn = [self setLeftItemWithContentName:@"已接工单 "];
...
- (void)viewDidLoad
{
    ...
    m_SearchView = [[JobGridSearchTypeView alloc] initWithSelectBlock:^(ENUM_SEARCH_TYPE type, BOOL isFinish) {
        DIF_StrongSelf
        strongSelf->m_ReorderType = type==ENUM_SEARCH_TYPE_DATE?@"B":@"A";
        if (isFinish)
        {
